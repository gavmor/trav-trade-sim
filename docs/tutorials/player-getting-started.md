...
> **📸 Screenshot:** `screenshots/player-join-campaign.png` — Join Campaign tab
> with the three input fields (Campaign Code, Character Name, PIN / Confirm PIN).
...
> **📸 Screenshot:** `screenshots/player-main-view.png` — Main map view showing
> the sidebar on the left with sector/world lists and the world detail panel with
> its five tabs on the right.
...
> **📸 Screenshot:** `screenshots/player-cargo-tab-ship-bar.png` — Cargo tab
> with the ship status bar showing ship name, credits, and hold stats.
